...
## Estado tras aprobación de CP-03
...
CP-04 queda abierto exclusivamente para preregistrar la calibración antes de ejecutar resultados finales o implementar producción.

La indexación de CP-01/CP-02/CP-03 en `knowledge/registry.json` se delega como mantenimiento documental independiente a QA/Antigravity, en rama separada, para no bloquear el diseño de CP-04 ni crear conflictos sobre esta rama.
...
| CP-04 | Diseño/preregistro de calibración | `in_progress` | Fijar grid de `n`, `p`, alpha/confidence; cobertura exacta por enumeración binomial; ancho, conservadurismo, monotonicidad, simetrías, boundaries, comparadores, métricas, holdout y criterios de aceptación antes de ejecutar resultados finales | Protocolo pre-registrado y aprobado por Product Owner antes de CP-05/CP-06 |
| CP-05 | Implementación candidata | `pending` | Implementar sólo métodos/contratos aprobados y tests; corregir routing incompatible; no activar routing automático | SHA candidato reproducible en rama aislada |
